...
public class ReplyDAO {
	...
	private static final String SELECTALL="SELECT * FROM REPLY R LEFT OUTER JOIN MEMBER M ON R.WRITER=M.MID ORDER BY RID DESC";
	private static final String SELECTALLBYMID="SELECT * FROM REPLY WHERE MID =? ";
	private static final String SELECTONE="SELECT * FROM REPLY R LEFT OUTER JOIN MEMBER M ON R.WRITER=M.MID WHERE RID=?";
	...
	private static final String UPDATEBYMID="UPDATE REPLY SET WRITER=NULL WHERE WRITER=?";
	...
	public boolean updateByMid(MemberDTO mDTO) {
		conn=JDBCUtil.connect();
		try {
			pstmt=conn.prepareStatement(UPDATEBYMID);
